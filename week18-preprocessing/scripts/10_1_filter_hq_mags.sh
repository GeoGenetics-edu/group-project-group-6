...
#SBATCH --output=/maps/projects/course_1/scratch/group6/group-project-group-6/week18-preprocessing/logs/extract_hq_mags_%x_%j.out   # stdout log
#SBATCH --error=/maps/projects/course_1/scratch/group6/group-project-group-6/week18-preprocessing/logs/extract_hq_mags_%x_%j.err    # stderr log
#SBATCH --ntasks=1
...
HQ_DIR="/maps/projects/course_1/scratch/group6/group-project-group-6/week18-preprocessing/data/07_1_hq_mags/"
EXTENSION="fa"
